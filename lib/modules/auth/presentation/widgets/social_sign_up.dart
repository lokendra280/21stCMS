    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: List.generate(SocialLoginType.values.length, (index) {
            if (Platform.isAndroid &&
                SocialLoginType.values[index] == SocialLoginType.apple) {
              return const SizedBox.shrink();
            } else {
              return SocialIcon(
                iconSrc: UIAssets.getSvg(SocialLoginType.values[index].iconSrc),
                press: () {
