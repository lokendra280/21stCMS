...
final _otpRemoteDataSource = Provider<OtpRemoteDataSource>(
    (ref) => OtpRemoteDataSourceImpl(dioClient: ref.watch(dioClientProvider)));
final _registerRemoteDaraSource = Provider<RegisterRemoteDataSource>((ref) =>
    RegisterRemoteDataSourceImpl(dioClient: ref.watch(dioClientProvider)));
...
final _socialLoginRemoteDataSource = Provider<SocialLoginDataSource>((ref) =>
    SocialLoginDataSourceImpl(dioClient: ref.watch(dioClientProvider)));
// * remote data source
...
//     Provider<OtpRepository>((ref) => OtpRepositoryImpl(
//           remoteDataSource: ref.watch(_otpRemoteDataSource),
//           networkInfo: ref.watch(networkInfoProvider),
//         ));
final registerRepositoryProvider =
    Provider<RegisterRepository>((ref) => RegisterRepositoryImpl(
