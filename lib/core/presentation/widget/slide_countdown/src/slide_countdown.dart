...
import 'utils/stream_duration_base.dart';
...
class SlideCountdown extends StatefulWidget {
  ...
  /// The amount of padding by which to inset the child.
  final EdgeInsets padding;

  /// The decoration to paint in front of the [Text].
  final Decoration? textDecoration;


  /// The amount of margin by which to inset the text.
  final EdgeInsets? textMargin;


  /// The amount of padding by which to inset the text.
...
class _SlideCountdownState extends State<SlideCountdown> with CountdownMixin {
  ...
  void _updateValue([Duration? duration]) {
    ...
    updateNotifier(
      updateDaysNotifier: widget.shouldShowDays ,
          // != null
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (BuildContext context, Duration duration, Widget? child) {
        ...
        final showDays = widget.shouldShowDays ;
            // != null ? widget.shouldShowDays!(duration) : true;
